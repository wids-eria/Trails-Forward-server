...
describe MaleMarten do
 ...
 let!(:male_marten) {create :male_marten, :world => world, :location => [1,1], :previous_location => world.resource_tile_at(2,2), :age => 0} 
 before do
...
describe FemaleMarten do
 let(:female_marten) {create :female_marten, :age => 0}
 it 'ticks' do
